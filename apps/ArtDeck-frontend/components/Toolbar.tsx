    ...
    return (
        <>
            ...
            <div
                ...
                } flex gap-2 items-center justify-center shadow-lg bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-90 rounded-lg px-4 py-1 text-xs font-mono sm:flex-wrap sm:justify-start sm:left-5 sm:top-5 sm:transform-none`}
            >
                {/* Tool Icons */}
                <IconButton
                    onClick={() => {
                ...
                <button
                    ...
                    className={`p-2 rounded-md ${
                        collaborativeMode ? "bg-green-500" : "bg-transparent"
                    } transition-colors duration-300 hover:bg-zinc-100 dark:hover:bg-zinc-700`}
                    title="Copy room URL for collaboration"
                >
                    <UsersRound
                        size={16}
                        className={`${
